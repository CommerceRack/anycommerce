...
URLS.unshift('/');
URLS.unshift('/about_us/');
URLS.unshift('/contact_us/');
URLS.unshift('/frequently_asked_questions/');
URLS.unshift('/payment_policy/');
URLS.unshift('/privacy_policy/');
URLS.unshift('/return_policy/');
URLS.unshift('/shipping_policy/');

URLS.unshift('/fieldcam/');
URLS.unshift('/affiliates/');
URLS.unshift('/connect_with_sportsworld/');
URLS.unshift('/careers/');
URLS.unshift('/inquiry/');
URLS.unshift('/rewards/');
URLS.unshift('/group_sales/');
