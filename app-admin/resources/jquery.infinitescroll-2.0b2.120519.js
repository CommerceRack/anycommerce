...
//added by JT.
//allows for a non-ajax response to get executed (load data that's already present, such as in the media library where the list of images is already present
