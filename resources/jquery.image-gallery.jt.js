...
//            './load-image.js',
 ...
 //JT -> wheel scroll barfs. event is never bound, so no need to unbind.
 /*               .unbind(
...
// JT -> mousewheel causes this to barf pretty bad.
//keyboard nav seems to work just fine.
/*                .bind(
                    'mousewheel.' + options.namespace +
                        ', DOMMouseScroll.' + options.namespace,
                    eventData,
...
*/            that._dialog
        ...
        _loadImage: function () {
            ...
            that._loaded = null;
//NOTE - changed the following line to window.loadImage to get this working right in the app
