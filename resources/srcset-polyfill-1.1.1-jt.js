...
//	  console.log("BEGIN getBestImage");
//	  console.log(srcsetInfo);
...
The code above is all untouched.
The code below was in an anonymous function. 
Also, the selector for images was changed to jquery and made more targeted (only gets images w/ srcset enabled).
Context was passed into the function for targeting purposes w/in the app.

*/
function handleSrcSetUpdate($context){
  ...
  function main() {
	...
	$imgs.each(function(){
		...
		if (srcset) {
			var srcsetInfo = new SrcsetInfo({src: img.src, srcset: srcset});
