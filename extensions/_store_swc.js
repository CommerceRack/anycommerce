...
//when adding an event, be sure to do off('click.appEventName') and then on('click.appEventName') to ensure the same event is not double-added if app events were to get run again over the same template.
		...
		validTeams : {
			...
			'app_nba' : [{"p": "Atlanta Hawks","v": "atlanta_hawks"},
						{"p": "Boston Celtics","v": "boston_celtics"},
						{"p": "Brooklyn Nets","v": "brooklyn_nets"},
						{"p": "Charlotte Bobcats","v": "charlotte_hornets"},
						{"p": "Chicago Bulls","v": "chicago_bulls"},
						{"p": "Cleveland Cavaliers","v": "cleveland_cavaliers"},
						{"p": "Dallas Mavericks","v": "dallas_mavericks"},
						{"p": "Denver Nuggets","v": "denver_nuggets"},
						{"p": "Detroit Pistons","v": "detroit_pistons"},
						{"p": "Golden State Warriors","v": "golden_state_warriors"},
						{"p": "Houston Rockets","v": "houston_rockets"},
						{"p": "Indiana Pacers","v": "indiana_pacers"},
						{"p": "Los Angeles Clippers","v": "los_angeles_clippers"},
						{"p": "Los Angeles Lakers","v": "los_angeles_lakers"},
						{"p": "Memphis Grizzlies","v": ""},
						{"p": "Miami Heat","v": "miami_heat"},
						{"p": "Milwaukee Bucks","v": "milwaukee_bucks"},
						{"p": "Minnesota Timberwolves",	"v": "minnesota_timberwolves"},
						{"p": "New Orleans Pelicans","v": "new_orleans_pelicans"},
						{"p": "New York Knicks","v": "new_york_knicks"},
						{"p": "Oklahoma City Thunder",	"v": "oklahoma_city_thunder"},
						{"p": "Orlando Magic","v": "orlando_magic"},
						{"p": "{Philadelphia 76ers","v": "philadelphia_76ers"},
						{"p": "Phoenix Suns","v": "phoenix_suns"},
						{"p": "Portland Trailblazers","v": "portland_trailblazers"},
						{"p": "Sacramento Kings","v": "sacramento_kings"},
						{"p": "San Antonio Spurs","v": "san_antonio_spurs"},
						{"p": "Toronto Raptors","v": "toronto_raptors"},
						{"p": "Utah Jazz","v": "utah_jazz"},
						{"p": "Washington Wizards","v": "washington_wizards"}],
			...
			'app_nhl' : [{"p":"Anaheim Ducks","v":"anaheim_ducks", "img":"nfl/tennessee_titans_cap.jpg"},
						...
						{"p":"Calgary Flames","v":"calgary_flames", "img":"nfl/tennessee_titans_cap.jpg"},
						{"p":"Carolina Hurricanes","v":"carolina_hurricanes", "img":"nfl/tennessee_titans_cap.jpg"},
						...
						{"p":"Columbus Blue Jackets","v":"columbus_blue_jackets", "img":"nfl/tennessee_titans_cap.jpg"},
						...
						{"p":"Edmonton Oilers","v":"edmonton_oilers", "img":"nfl/tennessee_titans_cap.jpg"},
						{"p":"Florida Panthers","v":"florida_panthers", "img":"nfl/tennessee_titans_cap.jpg"},
						{"p":"Los Angeles Kings","v":"los_angeles_kings", "img":"nhlhats/los_angeles_kings_hat.jpg"},
						{"p":"Minnesota Wild","v":"minnesota_wild", "img":"nfl/tennessee_titans_cap.jpg"},
						{"p":"Montreal Canadiens","v":"montreal_canadiens", "img":"nfl/tennessee_titans_cap.jpg"},
						{"p":"Nashville Predators","v":"nashville_predators", "img":"nfl/tennessee_titans_cap.jpg"},
						{"p":"New Jersey Devils","v":"new_jersey_devils", "img":"nfl/tennessee_titans_cap.jpg"},
						{"p":"New York Islanders","v":"new_york_islanders", "img":"nfl/tennessee_titans_cap.jpg"},
						{"p":"New York Rangers","v":"new_york_rangers", "img":"nhlhats/new_york_rangers_hat1.jpg.jpg"},
						{"p":"Ottawa Senators","v":"ottawa_senators", "img":"nfl/tennessee_titans_cap.jpg"},
						{"p":"Philadelphia Flyers","v":"philadelphia_flyers", "img":"nhlhats/philadelphia_flyers_hat.jpg"},
						{"p":"Phoenix Coyotes","v":"phoenix_coyotes", "img":"nfl/tennessee_titans_cap.jpg"},
						{"p":"Pittsburgh Penguins","v":"pittsburgh_penguins", "img":"nhlhats/pittsburgh_penguins_hat.jpg"},
						{"p":"San Jose Sharks","v":"san_jose_sharks", "img":"nfl/tennessee_titans_cap.jpg"},
						{"p":"St. Louis Blues","v":"st_louis_blues", "img":"nfl/tennessee_titans_cap.jpg"},
						{"p":"Tampa Bay Lightning","v":"tampa_bay_lightning", "img":"nfl/tennessee_titans_cap.jpg"},
						{"p":"Toronto Maple Leafs","v":"toronto_maple_leafs", "img":"nfl/tennessee_titans_cap.jpg"},
						{"p":"Vancouver Canucks","v":"vancouver_canucks", "img":"nfl/tennessee_titans_cap.jpg"},
						{"p":"Washington Capitals","v":"washington_capitals", "img":"nhlhats/washington_capitals_hat.jpg"},
						{"p":"Winnipeg Jets","v":"winnipeg_jets", "img":"nfl/tennessee_titans_cap.jpg"}],
				},
