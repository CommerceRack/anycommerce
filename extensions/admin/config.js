	...
	//the UPS account has not been registered through us yet. show reg form.
			...
			showCouponManager : function($target)	{
				_app.ext.admin.i.DMICreate($target,{
					...
					'buttons' : [
						"<button data-app-click='admin_batchjob|adminBatchJobExec' data-type='BATCHJOB::EXPORT::RULES' data-element data-export='coupon' data-whitelist='export' class='applyButton' data-text='false' data-icon-primary='ui-icon-arrowthickstop-1-s'>Download Coupon Rules<\/button>",
